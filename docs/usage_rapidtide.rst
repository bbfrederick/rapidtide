...
.. csv-table::  Output files produced by rapidtide
   ...
   :widths: 30, 10, 30, 20
    ...
    "XXX_desc-maxtimecorrected_map", "nii.gz, json", "Lag time in seconds, corrected", "Present if refinedelay is enabled"
    ...
    "XXX_desc-ratiotodelaymapping_timeseries", "tsv.gz, json", "The ratio of sLFO derivative to the sLFO, and the corresponding delay offset", "Present if refinedelay is enabled and outputlevel is ≥ normal"
