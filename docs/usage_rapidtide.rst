...
.. csv-table::
   ...
   :widths: 15, 15, 30, 10
    ...
    "XXX_desc-MTT_map", "nii.gz, json", "Mean transit time estimate", "Always"
    ...
    "XXX_desc-lfofilterRemoved_bold", "nii.gz, json", "sLFO signal filtered out of this voxel", "Present if despecklepasses > 0 (default) and outputlevel is max"
    ...
    "XXX_runtimings", "tsv", "Raw timing information", "Always"
..
