...
filter.py, correlate.py, resample.py, fit.py, io.py, miscmath.py, stats.py, util.py
-------------

Description:
^^^^^^^^^^^^
	These are the libraries containing most of the routines that do the heavy lifting.
