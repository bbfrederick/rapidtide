...
def test_findmaxlag(display=False, debug=False):
    ...
    assert eval_fml_sigma(0.0, absmaxsigma, testsigmas, fml_maxsigmas)
    assert eval_fml_sigma(0.0, absmaxsigma, testsigmas, fmlr_maxsigmas)
    assert eval_fml_sigma(0.0, absmaxsigma, testsigmas, fmlc_maxsigmas)
