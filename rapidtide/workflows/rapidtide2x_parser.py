...
def usage():
    ...
    print("    --padseconds=SECONDS           - Set the filter pad time to SECONDS seconds.  Default")
    print("                                     is 30.0")
    print("    -N NREPS                       - Estimate significance threshold by running NREPS null ")
    print("                                     correlations (default is 10000, set to 0 to disable).  If you are")
    print("                                     running multiple passes, 'ampthresh' will be set to the 0.05 significance.")
    print("                                     level unless it is manually specified (see below).")
    ...
    print("                                     coefficients less than AMP (default is 0.3).  NOTE: ampthresh will")
    print("                                     automatically be set to the p<0.05 significance level determined by")
    print("                                     the -N option if -N is set greater than 0 and this is not ")
