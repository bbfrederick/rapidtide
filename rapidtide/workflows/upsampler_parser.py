...
def _get_parser():
    """
    Argument parser for upsampler
    """
    parser = argparse.ArgumentParser(
        prog="Upsampler",
        description="Upsample multiband fMRI data.",
    )
    ...
    processing_steps.add_argument(
        ...
        action="store_true",
        help=(
            "If a non-json slicetime file is specified, upsampler assumes the file is FSL style "
    ...
    cardiac_est_tuning.add_argument(
        ...
        help=(
            ...
            "selected, upsampler will only make a single pass through the data (the "
