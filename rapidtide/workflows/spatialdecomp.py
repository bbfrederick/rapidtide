...
def _get_parser():
    ...
    parser.add_argument('outputroot',
                        help='The root name for the output nifti files')
    ...
    parser.add_argument('--type',
                        ...
                        default='pca')
    parser.add_argument('--nodemean',
                        dest='demean',
                        action='store_false',
                        help=('Do not demean data prior to decomposition.'),
                        default=True)
    parser.add_argument('--novarnorm',
                        dest='varnorm',
                        action='store_false',
...
def spatialdecomp_workflow(datafile,
                           outputroot,
                           datamaskname=None,
                           decomptype='pca',
                           pcacomponents=0.5,
    ...
    if decomptype == 'ica':
        ...
        tide_io.writenpvecs(100.0 * thefit.explained_variance_ratio_, outputroot + '_explained_variance_pct.txt')
        ...
        tide_io.savetonifti(tempout.reshape((xsize, ysize, numslices, thecomponents.shape[1])), datafile_hdr,
...
def main():
    ...
    spatialdecomp_workflow(args['datafile'],
                           args['outputroot'],
