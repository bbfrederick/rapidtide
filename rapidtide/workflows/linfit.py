...
def _get_parser():
    ...
    parser.add_argument('templatemask',
                        type=lambda x: is_valid_file(parser, x),
    ...
    parser.add_argument('--regionatlas',
                        metavar='ATLASFILE',
                        dest='regionatlas',
                        type=lambda x: is_valid_file(parser, x),
...
def linfit(datafile,
    ...
    datafile_img, datafile_data, datafile_hdr, datafiledims, datafilesizes = tide_io.readfromnifti(datafile)
    datamask_img, datamask_data, datamask_hdr, datamaskdims, datamasksizes = tide_io.readfromnifti(datamask)
    ...
    if regionatlas is not None:
        regionatlas_img, regionatlas_data, regionatlas_hdr, regionatlasdims, regionatlassizes = tide_io.readfromnifti(regionatlas)
    ...
    tide_io.savetonifti(fitdata.reshape((xsize, ysize, numslices, timepoints)), datafile_hdr,
                        outputroot + '_fit')
    tide_io.savetonifti(residuals.reshape((xsize, ysize, numslices, timepoints)), datafile_hdr,
