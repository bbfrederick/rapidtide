...
def _get_parser():
    ...
    parser.add_argument("infilename", help="the name of the input two column file")
    parser.add_argument(
        "timestep",
        type=float,
...
def tcfrom2col(args):
    ...
    outputdata = tide_util.maketcfrom2col(inputdata, timeaxis, outputdata, debug=args.debug)
