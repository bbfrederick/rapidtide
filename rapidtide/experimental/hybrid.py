...
from keras.layers import Bidirectional, Convolution1D, Dense, Activation, Dropout, BatchNormalization, LSTM, TimeDistributed
from keras.callbacks import TerminateOnNaN, ModelCheckpoint


def hybrid(window_size, num_layers, num_filters, kernel_size, dropout_rate, num_epochs,
        thesuffix='25.0Hz',
