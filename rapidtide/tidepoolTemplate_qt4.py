...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 1091, 276))
        ...
        self.aspects_verticalLayout.addWidget(self.label_5)
        self.report_pushButton = QtGui.QPushButton(self.layoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.report_pushButton.sizePolicy().hasHeightForWidth())
        self.report_pushButton.setSizePolicy(sizePolicy)
        self.report_pushButton.setMinimumSize(QtCore.QSize(0, 24))
        self.report_pushButton.setObjectName(_fromUtf8("report_pushButton"))
        self.aspects_verticalLayout.addWidget(self.report_pushButton)
        self.aspects_checkBox = QtGui.QCheckBox(self.layoutWidget)
        self.aspects_checkBox.setObjectName(_fromUtf8("aspects_checkBox"))
        self.aspects_verticalLayout.addWidget(self.aspects_checkBox)
        ...
        self.verticalLayout_2.addLayout(self.aspects_verticalLayout)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.report_pushButton.setText(_translate("MainWindow", "Calculate", None))
        self.aspects_checkBox.setText(_translate("MainWindow", "Show stat image", None))
